...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_THI_WARP_PIPE, -2238, -967, -1145, 0, 0, 0, (0x29 << 16), bhvWarpPipe, 0),
		...
		OBJECT(MODEL_NONE, 4266, -599, 4774, 0, 180, 0, (0x45 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -1533, -546, -1005, 0, 158, 0, (0x39 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, 4269, -599, 4762, 0, 180, 0, (0x35 << 16), bhvAirborneStarCollectWarp),
