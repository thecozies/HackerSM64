...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -2201, -967, -1190, 0, 0, 0, (0x54 << 16), bhvWarpPipe),
		...
		OBJECT(MODEL_NONE, -1466, -1649, 4256, 0, -17, 0, (10 << 24) | (0x53 << 16), bhvWarp),
		...
		OBJECT(MODEL_NONE, 3267, -1203, 176, 0, -90, 0, (10 << 24) | (0x22 << 16), bhvWarp),
