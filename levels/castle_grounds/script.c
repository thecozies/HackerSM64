...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, 3175, 1070, 189, 0, 180, 0, (0x48 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 786, -759, 3655, 0, 180, 0, (0x44 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 1957, 1364, -2763, 0, 180, 0, (0x47 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -2251, 3610, 1157, 0, 180, 0, (0x70 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -3139, -882, 2921, 0, 180, 0, (0x71 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -3139, -882, 2398, 0, 180, 0, (0x72 << 16), bhvDeathWarp),
		...
		OBJECT(MODEL_NONE, 3177, 1070, 177, 0, 180, 0, (0x38 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, 788, -759, 3644, 0, 180, 0, (0x34 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, 1959, 1364, -2774, 0, 180, 0, (0x37 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, -2249, 3610, 1146, 0, 180, 0, (0x60 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, -3137, -882, 2909, 0, 180, 0, (0x61 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, -3137, -882, 2386, 0, 180, 0, (0x62 << 16), bhvAirborneStarCollectWarp),
