...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 105, 2807, 1186, 0, 0, 0, ((COIN_FORMATION_FLAG_VERTICAL | COIN_FORMATION_FLAG_FLYING) << 16) | (0), bhvCoinFormation),
		OBJECT(MODEL_NONE, 105, 3854, 1186, 0, 0, 0, ((COIN_FORMATION_FLAG_VERTICAL | COIN_FORMATION_FLAG_FLYING) << 16) | (0), bhvCoinFormation),
		...
		OBJECT(MODEL_HANGING_PLAT, -1493, -462, -7696, 0, 0, 0, (40 << 24) | (0 << 16) | (0 << 8) | (18), bhvHangingPlat),
		OBJECT(MODEL_HANGING_PLAT, 107, -462, -7696, 0, 0, 0, (40 << 24) | (0 << 16) | (0 << 8) | (18), bhvHangingPlat),
		OBJECT(MODEL_HANGING_PLAT, 751, -462, -8122, 0, 0, 0, (60 << 24) | (0 << 16) | (0 << 8) | (22), bhvHangingPlat),
		OBJECT(MODEL_HANGING_PLAT, 1890, -2950, -8762, 0, 0, 0, (40 << 24) | (0 << 16) | (0 << 8) | (9), bhvHangingPlat),
		OBJECT(MODEL_HANGING_PLAT, -1409, -2950, -10101, 0, 0, 0, (40 << 24) | (0 << 16) | (0 << 8) | (20), bhvHangingPlat),
		...
		OBJECT(MODEL_NONE, 109, -1915, -6541, 0, 0, 0, (0 << 16) | (0), bhvHiddenRedCoinStar),
		OBJECT(MODEL_STAR, 5617, 3818, 2119, 0, 0, 0, (1 << 24) | (0 << 8), bhvStar),
		OBJECT(MODEL_STAR, -7301, 4510, 1848, 0, 0, 0, (2 << 24) | (0 << 8), bhvStar),
