void scroll_ab_dl_Azure_Abyss2_mesh_layer_1_vtx_20() {
	int i = 0;
	int count = 7;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(ab_dl_Azure_Abyss2_mesh_layer_1_vtx_20);
...
void scroll_ab() {
	scroll_ab_dl_Azure_Abyss2_mesh_layer_1_vtx_20();
