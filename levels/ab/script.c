...
const LevelScript level_ab_entry[] = {
	...
	AREA(1, ab_area_1),
		...
		MARIO_POS(0x01, -2, 8844, -125, -8898),
		...
		OBJECT(MODEL_CLAM_SHELL, 12932, 154, -11836, 0, -2, 0, 0x00000000, bhvClamShell),
		OBJECT(MODEL_CLAM_SHELL, 13527, 202, -13224, 0, -2, 0, 0x00000000, bhvClamShell),
		...
		OBJECT(MODEL_CLAM_SHELL, 12563, 175, -13345, 0, -2, 0, 0x00000000, bhvClamShell),
		...
		OBJECT(MODEL_NONE, -4239, -153, -4773, 0, -2, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -1835, 69, -423, 0, 143, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -3109, -2246, -9004, 0, -60, 0, (6 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_RED_COIN, 475, -2372, -7725, 0, -2, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_SKEETER, 402, -519, -8254, 0, -2, 0, 0x00000000, bhvSkeeter),
		...
		OBJECT(MODEL_NONE, -4247, 211, -4785, 0, -2, 0, (0 << 24), bhvHiddenRedCoinStar),
