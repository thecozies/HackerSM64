...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_NONE, 14887, -1224, -2650, 0, 0, 0, (1 << 16), bhvSlideCheckpoint),
		OBJECT(MODEL_NONE, 19535, 523, 715, 0, 0, 0, (2 << 16), bhvSlideCheckpoint),
		OBJECT(MODEL_NONE, -468, 2772, 406, 0, 1, 0, 0x00000000, bhvSlideCheckpointCtl),
		OBJECT(MODEL_STAR, -377, -1203, 6918, 0, 0, 0, 0x00000000, bhvStar),
		TERRAIN(pss_area_1_collision),
		MACRO_OBJECTS(pss_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_FADE_HILL),
