...
const LevelScript level_hf_entry[] = {
	...
	AREA(1, hf_area_1),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_COURTYARD, 0x01, 0x34, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x44, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 0, 1203, 2306, 6699),
		...
		OBJECT(MODEL_STAR, -101, 4062, -11760, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 13278, 4000, 4595, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 6680, 3666, 9925, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 1646, 10603, -525, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -6854, 5052, -2, 0, 0, 0, 0x00000000, bhvStar),
