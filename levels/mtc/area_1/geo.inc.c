...
const GeoLayout mtc_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, mtc_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_ALPHA, mtc_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mtc_dl_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
