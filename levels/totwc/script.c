...
const LevelScript level_totwc_entry[] = {
	...
	AREA(1, totwc_area_1),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE_GROUNDS, 0x01, 0x61, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE_GROUNDS, 0x01, 0x71, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00000000, bhvAxoController),
		OBJECT(MODEL_FLIPNOTE_FROG, -361, 1000, 0, 0, 90, 0, 0x00000000, bhvFlipnoteFrog),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_FLIPNOTE),
