...
const GeoLayout sa_dl_Room1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4654, 11226, 3549, sa_dl_0Area7Visual_mesh_layer_1),
		GEO_ASM(0x00, geo_render_INFBG),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 10125, -10491, 3549, sa_dl_Area7Bottom_mesh_layer_1),
...
const GeoLayout sa_dl_Room2_geo[] = {
	...
	GEO_OPEN_NODE(),
		GEO_ASM(0x00, geo_render_INFBG),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 10125, -10491, -1451, sa_dl_Area7Room2_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
