...
const LevelScript level_sa_entry[] = {
	...
	AREA(1, sa_area_1),
		...
		OBJECT(MODEL_BLINKING_PLATFORM, 12455, 400, 403, 0, 0, 0, (0x01 << 16), bhvBlinkingPlatform),
		OBJECT(MODEL_BLINKING_PLATFORM, 12455, 700, 103, 0, 0, 0, (0x01 << 16), bhvBlinkingPlatform),
		OBJECT(MODEL_BLINKING_PLATFORM, 10186, 1000, 0, 0, 0, 0, (0x01 << 24) | (0x03 << 8), bhvBlinkingPlatform),
		OBJECT(MODEL_BLINKING_PLATFORM, 10486, 1000, 0, 0, 0, 0, (0x00 << 24) | (0x03 << 8), bhvBlinkingPlatform),
		OBJECT(MODEL_BLINKING_PLATFORM, 11564, 1307, 0, 0, 0, 0, (0x01 << 24) | (0x02 << 16) | (0x02 << 8) | (0x02), bhvBlinkingPlatform),
		OBJECT(MODEL_BLINKING_PLATFORM, 9886, 1000, 0, 0, 0, 0, (0x02 << 24) | (0x03 << 8), bhvBlinkingPlatform),
