...
const LevelScript level_sa_entry[] = {
	...
	AREA(1, sa_area_1),
		...
		OBJECT(MODEL_BLINKING_PLATFORM, 9331, 3100, 0, 0, 0, 0, (0x01 << 24) | (20 << 8) | (60), bhvBlinkingPlatform),
	...
	AREA(3, sa_area_3),
		...
		OBJECT(MODEL_NONE, 18497, 5768, -499, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
	...
	AREA(6, sa_area_6),
		...
		OBJECT(MODEL_BULLET_BILL, 2268, 2624, -3144, 0, 0, 0, 0x00000000, bhvBulletBill),
		...
		OBJECT(MODEL_SPRING, 3931, 3329, 3475, 0, 0, 0, (0x01 << 16), bhvSpring),
		OBJECT(MODEL_SPRING, 5506, 4165, 3475, 0, 0, 0, (0x01 << 16), bhvSpring),
	...
	AREA(7, sa_area_7),
		...
		OBJECT(MODEL_SPRING, 5506, 10465, 3475, 0, 0, 0, (0x01 << 16), bhvSpring),
